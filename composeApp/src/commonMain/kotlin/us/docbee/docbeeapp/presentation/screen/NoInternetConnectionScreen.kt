...
import docbee.composeapp.generated.resources.Res.string as resString
...
fun NoInternetConnectionScreen() {
    Box(
        ...
        Column(
            ...
            Text(
                stringResource(resString.no_internet_connection_title),
                style = TextStyle(color = White),
            )
            Text(
                stringResource(resString.no_internet_connection_paragraph),
                style = TextStyle(color = White),
            )
        }
    }
